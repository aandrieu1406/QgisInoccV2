...
from .qgis_inocc_dialog import QGisInoccDialog
import os.path
...
class QGisInocc:
    ...
    def __init__(self, iface):
        ...
        self.dlg = QGisInoccDialog ()

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&QGIS Inocc')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('QGisInocc', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/qgis_inocc/src/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'QGisInocc'),
            callback=self.run,
    ...
    def run(self):
        ...
        #*************************************************************************
        #Création d'une fenêtre pop-up pour la première ouverture de l'application                !!!!!!!!!!!!!!!!!!!!A FAIRE !!!!!!!!!!!!!!!!!!!!!!!!!!
        #*************************************************************************
        self.dlg.show()
        if self.openParam :
           #ouverture de ma boite de dialogue de paramètrage
    ...
    def returnDialogParam(self):
        ...
        mDicAutre["openParam"] = "true"            
        mDicAutre["AdrServPG"] = ""
        mDicAutre["port"] = ""
        mDicAutre["user"] = ""
        mDicAutre["mdp"] = ""
        mDicAutre["NomBD"] = ""
        mDicAutre["schema"] = "public"
        mDicAutre["dossierSortie"] = "C:/qgis_inocc_result"
